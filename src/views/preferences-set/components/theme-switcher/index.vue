<template>
  <div
    class="relative flex h-8 w-8 cursor-pointer items-center justify-center rounded-full text-[hsl(var(--foreground)/.8)] transition-all duration-150 ease-in-out hover:animate-[shrink_0.3s_ease-in-out] hover:bg-[hsl(var(--accent))] hover:text-[hsl(var(--accent-foreground))]"

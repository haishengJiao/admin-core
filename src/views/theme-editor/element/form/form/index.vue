    ...
    <div class="flex flex-wrap gap-2">
      ...
      >
        ...
        <el-form-item label="Activity count" prop="count">
          <el-select-v2 v-model="ruleForm.count" :options="options" placeholder="Activity count" />
        </el-form-item>
        <el-form-item label="Activity time" required>
          ...
          <el-col :span="11">
            <el-form-item prop="date2">
              <el-time-picker v-model="ruleForm.date2" class="w-full" label="Pick a time" placeholder="Pick a time" />
            </el-form-item>
          </el-col>
        </el-form-item>
